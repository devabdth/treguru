    ...
    projects: [
      {
        ...
        projectId: "tg-24@001",
        backgroundImage: `${process.env.NEXT_PUBLIC_HOST}/api/assets/?type=projects&subtype=covers&id=0.png`,
        projectDisplayImages: [
          `${process.env.NEXT_PUBLIC_HOST}/api/assets/?type=projects&subtype=materials&id=0.png`,
          `${process.env.NEXT_PUBLIC_HOST}/api/assets/?type=projects&subtype=materials&id=1.png`,
          `${process.env.NEXT_PUBLIC_HOST}/api/assets/?type=projects&subtype=materials&id=2.png`,
          `${process.env.NEXT_PUBLIC_HOST}/api/assets/?type=projects&subtype=materials&id=3.png`,
          `${process.env.NEXT_PUBLIC_HOST}/api/assets/?type=projects&subtype=materials&id=4.png`,
          `${process.env.NEXT_PUBLIC_HOST}/api/assets/?type=projects&subtype=materials&id=5.png`,
        ],
      },
      {
        title: "Sky Elevators",
